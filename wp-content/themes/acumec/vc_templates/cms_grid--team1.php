                            ...
                            <ul class="team-contact" style="<?php echo esc_attr($color); ?>">
                                <?php if (!empty($atts['show_email']) && $atts['show_email'] == 1): ?>
                                     <?php if (!empty($opt_meta_options['team_email'])): ?>
                                        <li><span class="title" style="<?php echo esc_attr($color); ?>"><?php echo esc_html__('EMAIL ADDRESS: ','acumec') ?></span><span><?php echo esc_attr( $opt_meta_options['team_email'] ); ?></span></li>
                                    <?php endif; ?>
                                <?php endif ?>
                                <?php if (!empty($atts['show_phone']) && $atts['show_phone'] == 1): ?>
                                    <?php if (!empty($opt_meta_options['team_phone'])): ?>
                                        <li><span class="title" style="<?php echo esc_attr($color); ?>"><?php echo esc_html__('PHONE NO: ','acumec') ?></span><span><?php echo esc_attr( $opt_meta_options['team_phone'] ); ?></span></li>
                                    <?php endif; ?>
                                <?php endif; ?>
                                <?php if (!empty($atts['show_location']) && $atts['show_location'] == 1): ?>
                                    <?php if (!empty($opt_meta_options['team_location'])): ?>
                                        <li><span class="title" style="<?php echo esc_attr($color); ?>"><?php echo esc_html__('LOCATION: ','acumec') ?></span><span><?php echo esc_attr( $opt_meta_options['team_location'] ); ?></span></li>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </ul>
                        <?php endif; ?>
