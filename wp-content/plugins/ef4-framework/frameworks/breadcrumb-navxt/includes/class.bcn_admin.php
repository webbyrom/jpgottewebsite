...
{
	require_once(dirname(__FILE__) . '/class.mtekk_adminkit.php');
}
/**
                ...
                <div id="hasadmintabs">
                    <fieldset id="general" class="bcn_options">
                        ...
                        <table class="form-table">
                            ...
                            $this->input_text(__('Home Page Title', 'breadcrumb-navxt'), 'home_title', 'regular-text', false, __('Breadcrumb home page title.', 'breadcrumb-navxt'));
                            ?>
                        </table>
                    </fieldset>
                </div>
                <p class="submit">
                    <input type="submit" class="button-primary" name="bcn_admin_options" value="<?php esc_attr_e('Save Changes') ?>" />
                </p>
            </form>
        </div>
        <?php
